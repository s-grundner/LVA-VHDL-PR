...
vcom -work work ../top_level.vhd
vcom -work work ../test/fsm_tb.vhd
...
add wave -r -color Yellow 			-label {Restart Strobe} /fsm_tb/dut_tl/counter_restart_strobe
add wave -r -color Salmon 			-label {Counter} 		/fsm_tb/dut_tl/counter_value
add wave -r -color Orange 			-label {FSM State} 		/fsm_tb/dut_tl/fsm_inst/fsm_state
add wave -r -color Orange 			-label {FSM Next State} /fsm_tb/dut_tl/fsm_inst/next_fsm_state
