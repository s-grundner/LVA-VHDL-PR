...
\subtitle{Hardwaredesign PR - Exercise 02\\%
...
\keywords{Sequential Circuits, FSM}
...
\section{Sequential Circuit}\label{section:sequential-circuit}
\input{tasks/task1}
\input{01-sequential-circuit}
